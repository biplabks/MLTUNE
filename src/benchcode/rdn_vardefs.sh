...
def_bs[${cfd}]="3"
def_bs[${dwt2d}]="4"
def_bs[${gaussian}]="-s 512"
def_bs[${heartwall}]="${input_dir}/heartwall/test.avi 20"
def_bs[${hotspot}]="7"
def_bs[${hotspot3d}]="8"
def_bs[${huffaman}]="9"
def_bs[${hybridsort}]="10"
def_bs[${kmeans}]="11"
def_bs[${lavaMD}]="128"
def_bs[${leukocyte}]="13"
def_bs[${lud}]="14"
...
def_bs[${nn}]="17"
def_bs[${nw}]="18"
def_bs[${particleFilter}]="19"
def_bs[${pathfinder}]="20"
def_bs[${srad}]="100 0.5 502 458"
def_bs[${streamcluster}]="22"
